...
const projects = [
  {
    num: '01 /',
    accentColor: '#5eead4',
    title: 'FinSight AI: SEC Filing Analysis Platform',
    bullets: [
    ...
    tags: ['Python', 'FastAPI', 'LangChain', 'RAG', 'FAISS', 'HuggingFace', 'LangSmith', 'Docker', 'React', 'GitHub Actions'],
    github: 'https://github.com/AlbenZap/finsight-ai',
    dashboard: 'https://finsight-ai-sec.vercel.app/',
    diagram: 'https://media.githubusercontent.com/media/AlbenZap/finsight-ai/main/docs/finsight-arch.png',
  },
  {
    num: '02 /',
    accentColor: '#38bdf8',
    title: 'U.S. Traffic Safety Intelligence Pipeline',
    bullets: [
    ...
    tags: ['AWS', 'S3', 'Lambda', 'EC2', 'SSM', 'SageMaker', 'SNS', 'PySpark', 'ETL', 'Power BI'],
    github: 'https://github.com/AlbenZap/aws-bigdata-mlops-pipeline',
    dashboard: null,
    diagram: 'https://raw.githubusercontent.com/AlbenZap/aws-bigdata-mlops-pipeline/main/aws-pipeline.png',
  },
  {
    num: '03 /',
    accentColor: '#f472b6',
    ...
    tags: ['Power BI', 'Power Query', 'DAX', 'Data Modeling', 'ArcGIS', 'Data Visualization'],
    github: 'https://github.com/AlbenZap/transit-ontime-dashboard',
